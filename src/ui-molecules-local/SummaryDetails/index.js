...
class SummaryDetails extends Component {
  ...
  render() {
    ...
    console.log(
      ...
      "documentsUploadRedux.documents"
    );
        ...
        {bookingData &&
          ...
          bookingData.map((item) => {
            return (
              ...
              //         />
              //         {
              //           content.jsonPath === "wfDocuments" ? {
              //             {documentsUploadRedux[0].documents &&
              //               documentsUploadRedux[0].documents.map((document, documentIndex) => {
              //                 console.log(document, documentIndex);
              ...
              <Grid container>
                {contents.map((content) => {
                  return content.jsonPath === "wfDocuments" ? (
                    <Grid item xs={4} style={{ marginBottom: 12 }}>
                      <Label
                        labelKey={this.getMessageFromLocalization(
                          content.label
                      ...
                      {/* <UploadedDocument
                    document={documentsUploadRedux[0].documents[0]}
                  /> */}
                    </Grid>
                  ) : (
                    <Grid item xs={4} style={{ marginBottom: 12 }}>
